...
const LimitOrdersList = () => {
    ...
    const formattedLimitOrders = useMemo(() => {
        ...
        return limitOrders.limitOrders.map(({ liquidity, initialLiquidity, killedLiquidity, owner, tickLower, tickUpper, zeroToOne, epoch, pool: poolId, killed }: any) => {
    ...
    const [closedOrders, openedOrders] = useMemo(() => {
        ...
        return formattedLimitOrders.reduce((acc: any, order: any) => {
